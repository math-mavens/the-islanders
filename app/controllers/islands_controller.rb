class IslandsController < ApplicationController
    ...
    @markers = Island.where(id: params[:id]).geocoded.map do |island|
      {
        ...
        image_url: helpers.asset_url("https://raw.githubusercontent.com/math-mavens/the-islanders/master/app/assets/images/map-pin.png")
      }
    end
  end
  ...
  def island_params
    params.require(:island).permit(:name, :description, :price_per_day, :address, photos: [])
  end
end
